...
public class AllP {
	...
	public  void MyAll() throws Exception {
		...
		Logger log =  LogManager.getLogger("AllP");
		PropertyConfigurator.configure("C:\\Users\\Andrei\\eclipse-workspace\\Selenium\\src\\main\\java\\Example\\All.properties");
		...
		String cat = "cat";
		field.sendKeys(cat);
		driver.findElement(By.xpath("//input[@value='Поиск в Google']")).click(); //looking for in google
...
//		act.release(drog).build().perform();
	...
	public   void screens (WebDriver driver) throws Exception { 
		...
		FileUtils.copyFile(src, new File("C:\\Users\\Andrei\\Desktop\\Java_Files\\Log4j\\AllP\\Screens\\" + dat.format(date)+ " " + this.getClass().getSimpleName() + ".png" ));
	}
